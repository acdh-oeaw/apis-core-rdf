...
#         if len(no_pairing_found) > 0 and Triple not in no_pairing_found:
...
#                         relationtype_class.add_related_entity_a_class_name(entity_class_name_a)
#                         relationtype_class.add_related_entity_b_class_name(entity_class_name_b)
#
