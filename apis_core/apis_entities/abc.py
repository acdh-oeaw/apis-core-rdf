...
class E21_Person(models.Model):
    ...
    def rdf_configs(cls):
        return {
            "http://www.dnb.info/*|/.*.rdf": "E21_PersonFromDNB.toml",
...
class E53_Place(models.Model):
    ...
    def rdf_configs(cls):
        return {
            "http://www.dnb.info/*|/.*.rdf": "E53_PlaceFromDNB.toml",
            "http://wwww.geonames.org|/.*.rdf*": "E53_PlaceFromGeonames.toml",
...
class E74_Group(models.Model):
    ...
    def rdf_configs(cls):
        return {
            "http://www.dnb.info/*|/.*.rdf": "E74_GroupFromDNB.toml",
