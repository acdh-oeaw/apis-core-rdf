...
the request object to the current user. This attribute is then used by the 
`VersionMixin` to set the `history_user` attribute of the historical record. 
...
.. code-block:: python
    ...
    MIDDLEWARE = [
        ...
        'apis_core.history.middleware.HistoryMiddleware',
        ...
    ]
