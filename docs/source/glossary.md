...
:   A relation is a connection between two entities. In the context of
    ...
    `apis_core.apis_relations.models.Triple`{.interpreted-text
    role="class"} class.

TempTriple

:   `apis_core.apis_relations.models.TempTriple`{.interpreted-text
    role="class"} is a subclass of the more generic
    `apis_core.apis_relations.models.Triple`{.interpreted-text
    role="class"} that allows to define dates directly on the relation.
