...
<https://docs.djangoproject.com/en/5.0/ref/models/fields/>`_ describing the
attributes of this entity. This could look like this:
...
migrations <https://docs.djangoproject.com/en/5.0/topics/migrations/>`_ your
...
lists all instances for that :term:`entity`, as well as form for creating,
